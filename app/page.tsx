...
const Page = () => {
  ...
  const handleViewHistory = () => {
    if (!user) {
      ...
      setAlertMessage("Please sign in to view your delivery history");
  ...
  const handleSearchOrder = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Order found, redirect to tracking page (no auth required)
    ...
    <div className="welcome-container">
      ...
      <div className="content-section">
        <div className="content-wrapper">
          ...
          {/* Track Package Section */}
          <form className="track-section" onSubmit={handleSearchOrder}>
            <label className="track-label">Track Your Package</label>
          ...
          <div className="divider">
            ...
            <div className="divider-text">Account Actions</div>
            <div className="divider-line"></div>
          </div>
